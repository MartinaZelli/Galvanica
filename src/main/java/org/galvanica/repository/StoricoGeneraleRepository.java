...
public interface StoricoGeneraleRepository extends CrudRepository<StoricoGenerale, Long> {
    ...
    @Query(value = """
            ...
            *
            ...
            WHERE
                eseguito_generale = ?1
              AND bagno_id_bagno = ?2
              AND tipologia_aggiunta like ?3
            ORDER BY data_creazione DESC
            """, nativeQuery = true)
    List<StoricoGenerale> storicoGeneraleDescList(boolean eseguito, Long idBagno,
    ...
    @Query(value = """
            ...
            WHERE
                bagno_id_bagno = ?1
            ORDER BY
                data_creazione DESC, eseguito_generale
            LIMIT ?2
            """, nativeQuery = true)
    ...
    @Query(value = """
            ...
            WHERE
                bagno_id_bagno = ?1
                AND tipologia_aggiunta  not like 'TEMPO'
            ORDER BY
                data_creazione DESC
