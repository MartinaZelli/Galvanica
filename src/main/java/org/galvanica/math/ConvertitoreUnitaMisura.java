...
public class ConvertitoreUnitaMisura {
	...
	public static Integer convertiQuantitaToDatabase(Double misura, UnitaDiMisura originalUnit) {
	...
	public static Double convertiQuantitaGenerico(double misura, UnitaDiMisura originalUnit,
	...
	public static UnitaDiMisura convertiUnitaMisuraPerDto(Integer misura, boolean sonoVolume) {
		if (sonoVolume) {
			if (misura < 999) {
	...
	public static Double convertiQuantitaPerDto(Integer quantita, Boolean sonoVolume) {
		if (sonoVolume) {
			if (quantita < 999) {
