...
public class StoricoDettaglioService {
	 ...
	 * Optional<StoricoDettaglio> storicoDettaglio =
	 * storicoDettaglioRepository.findById(
	 * id);
	 ...
	 * Double quantita) {
	 * Optional<StoricoDettaglio> storicoDettaglioOptional =
	 * storicoDettaglioRepository.findById(
	 * idStoricoDettaglio);
	 ...
	 * Double quantita =
	 * convertitore.convertiQuantitaGenerico(oggettoDaTrasformare.getQuantita()
	 * .doubleValue(),
