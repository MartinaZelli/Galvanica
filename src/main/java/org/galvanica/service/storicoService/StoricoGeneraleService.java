...
public class StoricoGeneraleService {
	// todo: riprendere metodi buoni e riportarli in nuova classe
	// StoricoTotaleService
	/*
	 ...
	 * Optional<StoricoGenerale> storicoGenerale =
	 * storicoGeneraleRepository.findById(
	 * id);
	 ...
	 * Optional<StoricoGenerale> storicoGeneraleOptional =
	 * storicoGeneraleRepository.findById(
	 * idStoricoGenerale);
	 ...
	 * Optional<StoricoGenerale> storicoGeneraleTrovato =
	 * storicoGeneraleRepository.findById(
	 * id);
	 ...
	 * }
	 *
	 * public StoricoGeneraleDto fromModelToDto(StoricoGenerale
	 * oggettoDaTrasformare) {
	 ...
	 * .moltiplicatoreAlimentazione(oggettoDaTrasformare.
	 * getMoltiplicatoreAlimentazione())
