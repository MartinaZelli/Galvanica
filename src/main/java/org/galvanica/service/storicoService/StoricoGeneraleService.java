...
public class StoricoGeneraleService {
    ...
    public StoricoGeneraleDto fromModelToDto(StoricoGenerale oggettoDaTrasformare) {
        return StoricoGeneraleDto.builder()
                ...
                .scattiTotali(oggettoDaTrasformare.getScattiTotaliBagno())
                .restoScatti(oggettoDaTrasformare.getRestoScattiBagno())
                ...
                .dataFine(oggettoDaTrasformare.getDataEsecuzione())
                .dataControlloTempo(oggettoDaTrasformare.getDataControlloTempo())
                .concluso(oggettoDaTrasformare.getEseguitoGenerale())
                .annullato(oggettoDaTrasformare.getAnnullatoGenerale())
