...
public class DettaglioAlimentazioneController {
    ...
    public DettaglioAlimentazioneController(DettaglioAlimentazioneService dettaglioAlimentazioneService,
    ...
    public String listaDettaglioAlimentazione(Model model) {
        model.addAttribute("alimentazioneList", alimentazioneService.findAllAlimentazione());
    ...
    public String eliminaDettaglioAlimentazione(@PathVariable Long id, Model model) {
        Long idRedirect = dettaglioAlimentazioneService.ricercaId(id).orElseThrow().getIdAlimentazione();
    ...
    public String relazioneAzioni(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("prodottoList", prodottoService.ricercaProdottiInseribiliPerDettaglioAlimentazione(id));
    ...
    public String aggiornaDettaglioAlimentazione(@RequestBody DettaglioAlimentazioneDto dettaglioAlimentazioneDto,
        ...
        DettaglioAlimentazioneDto dettaglio = dettaglioAlimentazioneService.aggiorna(dettaglioAlimentazioneDto);
    ...
    public String newDettaglioAlimentazione(@PathVariable Long id, Model model) {
        model.addAttribute("prodottoList", prodottoService.ricercaProdottiInseribiliPerAlimentazione(id));
        model.addAttribute("unitaDiMisuraList", mathService.unitaDiMisuraList());
        model.addAttribute("alimentazione", alimentazioneService.ricercaId(id).orElseThrow());
