...
public class AlimentazioneController {
	...
	public AlimentazioneController(AlimentazioneService alimentazioneService,
		BagnoService bagnoService, MathService mathService) {
	...
	@PostMapping
	public String inserisciAlimentazione(@RequestBody AlimentazioneDto alimentazioneDto,
		Model model) {
	...
	public String alimentazioneAzioni(@PathVariable Long id, Model model) {
		AlimentazioneDto alimentazioneDto = alimentazioneService.ricercaId(id).orElseThrow();
	...
	@PutMapping("{id}")
	public String aggiornaAlimentazione(@RequestBody AlimentazioneDto alimentazioneDto,
