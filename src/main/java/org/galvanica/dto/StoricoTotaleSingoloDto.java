...
public class StoricoTotaleSingoloDto extends StoricoTotaleDto implements Cloneable {
	...
	@Builder
	public StoricoTotaleSingoloDto(Long idStoricoDettaglio, Long idStoricoGenerale, Long idBagno,
		String nomeBagno, Double quantitaProdotto, UnitaDiMisura unitaDiMisura, Long idProdotto,
		String nomeProdotto, Long idAlimentazione, Double moltiplicatoreAlimentazione,
		Integer restoScattiBagno, Integer scattiAlimentazione, Integer scattiTotaliBagno,
		Integer scattiInseriti, Integer restoScattiPrecedenti, LocalDate dataControlloTempo,
		TipologiaAggiunta tipologiaAggiunta, Boolean eseguitoDettaglio, Boolean annullatoDettaglio,
		Boolean eseguitoGenerale, Boolean annullatoGenerale, String noteStoricoGenerale,
		LocalDateTime dataCreazione, LocalDateTime dataEsecuzione, String rispostaCalcoloFront) {
